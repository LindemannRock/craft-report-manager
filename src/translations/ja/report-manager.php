...
return [
    ...
    'Site' => 'サイト',
    'Sites' => 'サイト',
    'Which sites to export (leave all unchecked to export all sites)' => 'エクスポートするサイト (すべてのサイトをエクスポートするには、すべてのチェックを外したままにしてください)',
    'Size' => 'サイズ',
    'Source' => 'ソース',
    'Status' => 'ステータス',
    'Type' => 'タイプ',
    ...
    'The configured export volume is unavailable. Check its volume and filesystem configuration, then try again.' => '設定されたエクスポートボリュームを利用できません。ボリュームとファイルシステムの設定を確認してから、もう一度お試しください。',
    ...
    'File Size' => 'ファイルサイズ',
    'Availability' => '利用可能状態',
    'Unresolved storage' => '未解決のストレージ',
    'Storage unavailable' => 'ストレージを利用できません',
    'This export was created before its storage location was recorded. Verify and assign its exact storage volume before downloading or deleting it.' => 'このエクスポートは、ストレージの場所が記録される前に作成されました。ダウンロードまたは削除する前に、正確なストレージボリュームを確認して割り当ててください。',
    ...
    'Craft Categories' => 'Craft カテゴリ',
    'Generate reports from Craft categories' => 'Craft カテゴリからレポートを生成します',
    'Category Group' => 'カテゴリグループ',
    'Category Groups' => 'カテゴリグループ',
    'Category Groups to Export' => 'エクスポートするカテゴリグループ',
    'Select one or more category groups to include in this report.' => 'このレポートに含めるカテゴリグループを 1 つ以上選択してください。',
    'Select one or more category groups to export. Each group will generate a separate export file.' => 'エクスポートするカテゴリグループを 1 つ以上選択してください。各グループは個別のエクスポートファイルを生成します。',
    'No category groups available.' => '利用可能なカテゴリグループはありません。',
    'Selected Category Groups' => '選択されたカテゴリグループ',
    'Category Group Name' => 'カテゴリグループ名',
